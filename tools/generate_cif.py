...
root_dir = '/vepfs-mlp2/mlp-public/shikunfeng/Datas/PDBBIND_atomCorrected/'
...
def check_folder_valid(folder_path, tag):
    ...
    required_files = [
        f"{tag}_ligand.sdf",
        f"{tag}_ligand_rdkit.sdf",
        f"{tag}_protein_esmfold_aligned_tr_fix.pdb",
        f"{tag}_protein_esmfold_aligned_tr_fix_processed_sorted.pdb",
        f"{tag}_protein_processed_fix.pdb",
        f"{tag}_protein_processed_fix_processed_sorted.pdb",
    ]
